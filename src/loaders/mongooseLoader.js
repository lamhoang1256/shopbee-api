...
var connectMongoDB = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, mongoose_1["default"].connect(env_1["default"].database.mongoUrl)];
            case 1:
                _a.sent();
            ...
            case 2:
                error_1 = _a.sent();
                console.log("Failed to connect to MongoDB - ".concat(error_1 === null || error_1 === void 0 ? void 0 : error_1.message));
