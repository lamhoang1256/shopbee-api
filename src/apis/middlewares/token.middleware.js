...
var verifyToken = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, accessToken, decodedAccessToken, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, jsonwebtoken_1["default"].verify(accessToken, env_1["default"].passport.jwtSecretKey)];
            case 2:
            ...
            case 3:
                err_1 = _a.sent();
                if ((err_1 === null || err_1 === void 0 ? void 0 : err_1.message) === "jwt expired") {
                    return [2 /*return*/, (0, response_1.responseError)(new api_error_1.ApiError(status_1.STATUS.UNAUTHORIZED, "Token đã hết hạn!", err_1), res)];
                }
                (0, response_1.responseError)(new api_error_1.ApiError(status_1.STATUS.UNAUTHORIZED, "Token không hợp lệ!", err_1), res);
                return [3 /*break*/, 4];
