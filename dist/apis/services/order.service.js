...
const createNewOrder = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (let i = 0; i < orderItems.length; i++) {
      yield product_model_1.default.findOneAndUpdate(
    ...
    const notify = {
      user: req.user._id,
      title: "Đã thanh toán",
      desc: `Đơn hàng <span class="notify-number-order">${savedOrder._id}</span> đã được thanh toán`,
      image:
        (firstProductOrder === null || firstProductOrder === void 0
          ? void 0
...
const getAllOrder = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!orders) throw new api_error_1.ApiError(404, "Không tìm thấy đơn hàng!");
...
const deleteOrder = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!deleteOrder) throw new api_error_1.ApiError(404, "Không tìm thấy đơn hàng!");
    const response = {
      message: "Xóa đơn hàng thành công!",
    };
    return response;
  });
const getAllOrderMe = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    let { page = 1, limit = 12, status, orderId } = req.query;
    page = Number(page);
    limit = Number(limit);
...
const getSingleOrder = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!order) throw new api_error_1.ApiError(404, "Không tìm thấy đơn hàng!");
    const response = {
...
const updateStatusOrderToProcessing = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    ...
    const notify = {
      user: order.user,
      title: "Đang xử lí",
      desc: `Đơn hàng <span class="notify-number-order">${id}</span> đang xử lí`,
...
const updateStatusOrderToShipping = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const order = yield order_model_1.default.findById(id).populate({
      path: "orderItems",
    ...
    const notify = {
      ...
      desc: `Đơn hàng <span class="notify-number-order">${id}</span> đang vận chuyển`,
      image: updatedOrder.orderItems[0].product.image,
    };
    yield notify_controller_1.default.addNewNotify(notify);
    const response = {
...
const updateStatusOrderToDelivered = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const order = yield order_model_1.default.findById(id).populate({
      path: "orderItems",
    ...
    const notify = {
      user: order.user,
      title: "Đã giao hàng",
      desc: `Đơn hàng <span class="notify-number-order">${id}</span> đã giao hàng thành công`,
      image: updatedOrder.orderItems[0].product.image,
    };
    yield notify_controller_1.default.addNewNotify(notify);
    const response = {
...
const updateStatusOrderToCancel = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const order = yield order_model_1.default.findById(id).populate({
      path: "orderItems",
    ...
    const notify = {
      user: order.user,
      title: "Đã hủy",
      desc: `Đơn hàng <span class="notify-number-order">${id}</span> đã hủy. ${
