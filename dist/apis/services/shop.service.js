...
const getSingleShop = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const shopAddress = yield shop_model_1.default.findById(req.params.id).lean();
    if (!shopAddress) throw new api_error_1.ApiError(404, "Không tìm thấy địa chỉ shop!");
    const response = {
...
const changeShopAddressDefault = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateShop = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const updatedAddress = yield shop_model_1.default.findByIdAndUpdate(req.params.id, req.body);
    if (!updatedAddress) throw new api_error_1.ApiError(404, "Không tìm thấy địa chỉ shop!");
    const response = {
...
const deleteShop = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const addressInDB = yield shop_model_1.default.findByIdAndDelete(req.params.id).lean();
    if (!addressInDB) throw new api_error_1.ApiError(400, "Không tìm thấy địa chỉ shop!");
    const response = {
