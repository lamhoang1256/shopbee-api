...
const getSingleProduct = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const product = yield product_model_1.default.findById(req.params.id);
    if (!product) throw new api_error_1.ApiError(404, "Không tìm thấy sản phẩm!");
    const response = {
...
const deleteProduct = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!deletedProduct) throw new api_error_1.ApiError(404, "Không tìm thấy sản phẩm!");
    const response = {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (price_min) {
      condition.price = condition.price
        ? Object.assign(Object.assign({}, condition.price), { $gte: price_min })
        : { $gte: price_min };
    }
