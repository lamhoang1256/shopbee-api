...
const getSingleVoucher = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const voucher = yield voucher_model_1.default.findById(req.params.id);
    if (!voucher) throw new api_error_1.ApiError(404, "Mã giảm giá không hợp lệ!");
    const response = {
...
const updateVoucher = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!updatedVoucher) throw new api_error_1.ApiError(404, "Mã giảm giá không hợp lệ!");
    const response = {
...
const deleteVoucher = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!addressInDB) throw new api_error_1.ApiError(404, "Mã giảm giá không hợp lệ!");
    const response = {
