...
const updateMe = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const updatedMe = yield user_model_1.default
      .findByIdAndUpdate({ _id: req.user._id }, req.body, { new: true })
      .select({ password: 0, __v: 0 })
      .lean();
    if (!updatedMe) throw new api_error_1.ApiError(404, "Không tìm thấy tài khoản người dùng!");
    const response = {
...
const updateUser = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const updatedUser = yield user_model_1.default
      ...
      .select({ password: 0, __v: 0 })
      .lean();
    if (!updatedUser) throw new api_error_1.ApiError(404, "Không tìm thấy tài khoản người dùng!");
    const response = {
      message: "Chỉnh sửa thông tin thành công!",
      data: updatedUser,
    };
...
const changePasswordMe = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { currentPassword, newPassword } = req.body;
    const userDB = yield user_model_1.default.findById(req.user._id);
    if (!userDB) throw new api_error_1.ApiError(404, "Không tìm thấy tài khoản người dùng!");
    ...
    if (!validPassword) throw new api_error_1.ApiError(422, "Mật khẩu hiện tại không đúng!");
    ...
    if (!updatedUser) throw new api_error_1.ApiError(500, "Đổi mật khẩu không thành công!");
    const response = {
...
const updateCreditCard = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (expiryYear < currentYear) throw new api_error_1.ApiError(500, "Thẻ đã hết hạn!");
    if (expiryYear === currentYear && expiryMonth <= currentMonth)
      throw new api_error_1.ApiError(500, "Thẻ đã hết hạn!");
    if (number.length < 16 || number.length > 19)
      throw new api_error_1.ApiError(500, "Số thẻ không hợp lệ!");
    if (cvc.length !== 3) throw new api_error_1.ApiError(500, "Mã bảo mật cvc gồm 3 chữ số!");
    const updatedCreditCard = yield user_model_1.default
      .findByIdAndUpdate(req.user._id, { creditCard: req.body }, { new: true })
      .select({ password: 0, __v: 0 })
      .lean();
    const response = {
...
const getAllUser = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!users) throw new api_error_1.ApiError(404, "Không tìm thấy người dùng!");
...
const getSingleUser = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!user) throw new api_error_1.ApiError(404, "Không tìm thấy người dùng!");
    const response = {
...
const deleteUser = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!deletedUser) throw new api_error_1.ApiError(404, "Không tìm thấy người dùng!");
...
const getMyVoucher = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!vouchers) throw new api_error_1.ApiError(404, "Không tìm thấy mã giảm giá!");
    const response = {
