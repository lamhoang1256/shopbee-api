...
const productControllers = {
    addNewProduct: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
    ...
    getSingleProduct: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const product = yield Product.findById(req.params.id).populate('category');
            const response = {
