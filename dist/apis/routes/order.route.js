...
orderRoutes.get("/", tokenMiddleware_1.default.verifyTokenAndAdmin, order_middleware_1.default.getAllOrderRules(), helpersMiddleware_1.default.entityValidator, order_controller_1.default.getAllOrder);
orderRoutes.get("/me", tokenMiddleware_1.default.verifyToken, order_middleware_1.default.getAllOrderMeRules(), helpersMiddleware_1.default.entityValidator, order_controller_1.default.getAllOrderMe);
