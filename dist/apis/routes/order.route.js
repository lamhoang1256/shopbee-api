...
orderRoutes.post("/", tokenMiddleware_1.default.verifyToken, order_controller_1.default.createNewOrder);
orderRoutes.get("/me", tokenMiddleware_1.default.verifyToken, order_controller_1.default.getAllOrderMe);
orderRoutes.get("/admin", tokenMiddleware_1.default.verifyTokenAndAdmin, order_controller_1.default.getAllOrderAdmin);
orderRoutes.get("/:id", tokenMiddleware_1.default.verifyToken, order_controller_1.default.getSingleOrder);
...
orderRoutes.put("/:id/canceled", tokenMiddleware_1.default.verifyToken, order_controller_1.default.updateStatusOrderToCancel);
