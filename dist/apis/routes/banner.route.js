...
bannerRoutes.put("/:id", helpersMiddleware_1.default.idRule("id"), helpersMiddleware_1.default.idValidator, bannerMiddleware_1.default.updateBannerRules(), helpersMiddleware_1.default.entityValidator, tokenMiddleware_1.default.verifyTokenAndAdmin, banner_controller_1.default.updateBanner);
