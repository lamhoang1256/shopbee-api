...
productRoutes.post("/:id/review", helpers_middleware_1.default.idRule("id"), helpers_middleware_1.default.idValidator, token_middleware_1.default.verifyToken, product_middleware_1.default.addNewReviewRules(), helpers_middleware_1.default.entityValidator, product_controller_1.default.addNewReview);
productRoutes.delete("/:id/review", helpers_middleware_1.default.idRule("id"), helpers_middleware_1.default.idValidator, token_middleware_1.default.verifyToken, product_controller_1.default.deleteReview);
productRoutes.put("/:id/review", helpers_middleware_1.default.idRule("id"), helpers_middleware_1.default.idValidator, token_middleware_1.default.verifyToken, product_middleware_1.default.updateReviewRules(), helpers_middleware_1.default.entityValidator, product_controller_1.default.updateReview);
